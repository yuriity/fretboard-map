...
describe('DeleteFretboardDialogComponent', () => {
  ...
  it('should display fretboard title in confirmation message', () => {
    ...
    expect(content.nativeElement.textContent)
      .withContext('Dialog should display fretboard title in confirmation message')
      .toContain('Test Fretboard');
  });
  ...
  it('should close dialog on cancel button click', () => {
    ...
    expect(dialogRefSpy.close)
      .withContext('Dialog should be closed on cancel button click')
      .toHaveBeenCalled();
  });
  ...
  it('should close dialog with true on confirm button click', () => {
    ...
    expect(dialogRefSpy.close)
      .withContext('Dialog should be closed with true on confirm button click')
